const MyPosts = [
    {
      ...
      userName: "Laura",
      userLastName: "Vargas",
      profilePhoto: "https://example.com/laura.jpg",
      ...
      travelPhotos: ["https://example.com/transmilenio.jpg"],
    ...
    },
    {
      ...
      travelPhotos: ["https://example.com/festival_teatro.jpg", "https://example.com/feria_libro.jpg"],
      location: "Bogotá, Colombia",
      tags: ["Eventos Locales", "Cultura", "Festival Iberoamericano de Teatro"]
    },
    {
      id: "@traveler11",
      userName: "Laura",
      ...
      travelPhotos: [""],
      location: "Bogotá, Colombia",
      tags: ["Seguridad Pública", "Precauciones", "Consejos de Seguridad"]
    },
    {
      id: "@traveler11",
      userName: "Laura",
      ...
      travelPhotos: ["https://example.com/ciclovia.jpg"],
      location: "Bogotá, Colombia",
    ...
    },
    {
      ...
      travelPhotos: ["https://example.com/camaras_seguridad.jpg"],
      location: "Bogotá, Colombia",
      tags: ["Tecnología", "Seguridad Pública", "Aplicaciones Móviles"]
    }
  ];
